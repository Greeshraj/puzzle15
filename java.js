 ...
 window.onload = function ()
{
	...
	gamePiece = gameplay.getElementsByTagName('div'); 
	var calcw=document.getElementsByClassName('bott');
...
for (var i=0; i<gamePiece.length; i++)  
	...
	var reset = document.getElementById('resetnow'); 
	spaceX = '300px'; 
	spaceY = '300px';
